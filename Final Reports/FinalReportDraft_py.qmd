...
```{python, fig.cap = "Figure #. Logistic Regression Coefficients", include = TRUE}
plt.clf()
sns.set_theme(context='notebook', style='darkgrid', palette='deep')

sns.barplot(x=df_lr_coef['Feature'], y=df_lr_coef['Coefficient'])
...
![](../NWI Outputs/decision_tree_feature_selection.png)
