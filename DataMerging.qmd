...
aqi <- read_csv(here("Project Data", "aqi.csv"))
co <- read_csv(here("Project Data", "co.csv"))
ozone <- read_csv(here("Project Data", "ozone.csv"))
no2 <- read_csv(here("Project Data", "no2.csv"))
so2 <- read_csv(here("Project Data", "so2.csv"))
wind <- read_csv(here("Project Data", "wind_speed.csv")) 
temp <- read_csv(here("Project Data", "temperature.csv"))
humid <- read_csv(here("Project Data", "relative_humidity.csv"))
pressure <- read_csv(here("Project Data", "pressure.csv"))
no <- read_csv(here("Project Data", "no.csv"))
```
...
aqi_ozone %>% write_csv(here("Project Data", "Final Data", "aqi_ozone.csv"))
aqi_pm2_5 %>% write_csv(here("Project Data", "Final Data", "aqi_pm2_5.csv"))
```
